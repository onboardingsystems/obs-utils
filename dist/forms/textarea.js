...
var ObsTextarea = function (_React$Component) {
  _inherits(ObsTextarea, _React$Component);

  function ObsTextarea(props) {
    _classCallCheck(this, ObsTextarea);

    var _this = _possibleConstructorReturn(this, (ObsTextarea.__proto__ || Object.getPrototypeOf(ObsTextarea)).call(this, props));
  ...
  _createClass(ObsTextarea, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_label2.default, { text: this.props.label, hint: this.props.hint, htmlFor: this.props.id, required: this.props.required }),
        _react2.default.createElement('textarea', { id: this.props.id, className: 'form-control', rows: this.props.rows, value: this.value(),
...
ObsTextarea.defaultProps = {
  ...
  autoFocus: false,
  errors: [],
  id: _lodash2.default.uniqueId('text_'),
